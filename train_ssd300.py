...
classes = ['background','Apple','apple','pple','ple','Private car']

n_classes = len(classes) # Number of classes including the background class, e.g. 21 for the Pascal VOC datasets

datadir = '/media/jeremy/9FBD-1B00/data/image_dbs'
datadir='/data/jeremy/image_dbs/apple'
apple_images = datadir
apple_annotations = datadir
apple_train_imageset = datadir+'/train_xml_files.txt'
apple_test_imageset = datadir+'/test_xml_files.txt'
apple_val_imageset = datadir+'/val_xml_files.txt'
...
train_dataset.parse_xml(images_paths=[apple_images,apple_images],
...
val_dataset.parse_xml(images_paths=[apple_images],
                      annotations_paths=[apple_images],
                      image_set_paths=[apple_test_imageset],
                      classes=classes,
                      include_classes='all',
                      exclude_truncated=False,
                      exclude_difficult=False,
...
print('{} val samples generated'.format(n_val_samples))
